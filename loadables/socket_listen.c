/* socket_listen - listen for a remote network connection on a given socket fd */
     ...
     WORD_LIST *list;
{
  ...
  accept_bind_variable (fdvar, servsock);
...
struct builtin socket_listen_struct = {
	"socket_listen",		/* builtin name */
	accept_builtin,		/* function implementing the builtin */
	BUILTIN_ENABLED,	/* initial flags for builtin */
	accept_doc,		/* array of long documentation strings. */
	"socket_listen [-b address] [-t timeout] [-v varname] [-r addrvar ] port",		/* usage synopsis; becomes short_doc */
